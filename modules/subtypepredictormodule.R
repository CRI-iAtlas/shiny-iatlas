    ...
    sectionBox(
      ...
      messageBox(
        ...
        tags$ul(
          ...
          tags$li("2. Data is upper quantile normalized and multiplied by 1000 (if selected)"),
          tags$li("3. Data is transformed with log2(x+1) (if selected)."),
          ...
          tags$li("6. Each gene is median centered, in the PanCancer and new-data sets jointly"),
